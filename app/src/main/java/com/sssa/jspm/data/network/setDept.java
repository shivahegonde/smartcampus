...
public class setDept {
    ...
    public static void SetDept(final Context context, final View view, final String username, final String department, final inputview inputview) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                AndroidNetworking.post(Constants.ASSIGNDEPT)
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (!goterror) {
                                        ...
                                        String msg = "Success Asign Department To "+username;
