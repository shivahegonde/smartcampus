...
public class setSub {
    ...
    public static void SetSub(final Context context, final View view, final String username, final String subject, final inputview inputview) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                AndroidNetworking.post(Constants.ASSIGNSUBJECT)
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (!goterror) {
                                        ...
                                        String msg = "Success Asign Subject To "+username;
