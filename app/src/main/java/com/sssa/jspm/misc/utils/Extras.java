...
import static com.sssa.jspm.misc.utils.Constants.ENDDATE;
import static com.sssa.jspm.misc.utils.Constants.FOURTHYR;
import static com.sssa.jspm.misc.utils.Constants.GFMBATCH;
import static com.sssa.jspm.misc.utils.Constants.GFMBATCHSTUDENTS;
import static com.sssa.jspm.misc.utils.Constants.GFMSTUDENT;
import static com.sssa.jspm.misc.utils.Constants.GFM_LOGIN;
import static com.sssa.jspm.misc.utils.Constants.GFM_LOGIN_TRACK;
import static com.sssa.jspm.misc.utils.Constants.INOUROUT;
import static com.sssa.jspm.misc.utils.Constants.NOTICETRACK;
import static com.sssa.jspm.misc.utils.Constants.NTEACHER_LOGIN;
import static com.sssa.jspm.misc.utils.Constants.NTEACHER_LOGIN_TRACK;
import static com.sssa.jspm.misc.utils.Constants.ONETIMESCREEN;
import static com.sssa.jspm.misc.utils.Constants.STARTDATE;
import static com.sssa.jspm.misc.utils.Constants.STUDENTINIT;
import static com.sssa.jspm.misc.utils.Constants.STUDENT_LOGIN;
import static com.sssa.jspm.misc.utils.Constants.STUDENT_LOGIN_TRACK;
import static com.sssa.jspm.misc.utils.Constants.SUBJECTNAME;
import static com.sssa.jspm.misc.utils.Constants.SYLLABUS;
import static com.sssa.jspm.misc.utils.Constants.TEACHER_LOGIN;
import static com.sssa.jspm.misc.utils.Constants.TEACHER_LOGIN_TRACK;
import static com.sssa.jspm.misc.utils.Constants.USERNAME;

/**
 * Created by Shiv on 2/20/2019.
 */
...
public class Extras {
    ...
    public String getGFMBatch(){
        return sharedPreferences.getString(GFMBATCH, null);
    }
    ...
    public void setGFMBatchStudents(boolean trackyr){
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(GFMBATCHSTUDENTS, trackyr);
        editor.apply();
    }
    ...
    public void saveGFMData(List<String> list) {
        String s = "";
        for (String i : list) {
            s += i + ",";
        }
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(GFMSTUDENT, s);
        editor.apply();
    }
